...
const ROEChart: React.FC<ROEChartProps> = ({ data, stockId }) => {
        ...
        <ChartContainer config={chartConfig}>
          ...
          >
            ...
            <Line
              dataKey="reportedROE"
              type="monotone"
              stroke="var(--color-reportedROE)"
              strokeWidth={2}
              dot={{
                fill: "var(--color-reportedROE)",
              }}
              activeDot={{
                r: 6,
              }}
            ...
            <Line
              ...
              type="monotone"
              stroke="var(--color-estimatedROE)"
              strokeWidth={2}
              dot={{
                fill: "var(--color-estimatedROE)",
              }}
              activeDot={{
                r: 6,
              }}
