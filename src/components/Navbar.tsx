        ...
        <div className="container px-4 mx-auto sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex lg:ml-16 lg:items-center lg:justify-center lg:space-x-10 xl:space-x-16">
              <Link
                href="/"
                className={`text-base font-medium transition-all duration-200 rounded font-pj ${
                  isPathActive("/")
                    ? "text-purple-600"
            ...
            <nav>
              <div className="px-1 py-8">
                <div className="grid gap-y-7">
                  <Link
                    href="/features"
                    className="flex items-center p-3 -m-3 text-base font-medium transition-all duration-200 rounded-xl hover:bg-gray-50 font-pj"
                  >
                    Features
                  </Link>
                  <Link
